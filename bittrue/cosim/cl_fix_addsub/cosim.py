                ...
                for bS in bS_values:
                    for bI in bI_values:
                        for bF in bF_values:
                            ...
                            # Repeat all combinations twice for add and sub
